              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <section class="form-group">
                      <label for="indica_curso">* Curso</label>
                      <select  class="form-control" id = "seleccionCurso">                                     
                        <option>    
                          indique un curso... 
                          </option>
                      </select> 
                      ...
                      <select name="" id="indica_asignatura" class="form-control">
                        <option> indique una asignatura...</option>
                      </select>

                      <label for="profesor">* Profesor</label>
                      <select name="" id="indica_profesor" class="form-control">
                        <option> indique un profesor...</option>
                      </select>
                    </section>
