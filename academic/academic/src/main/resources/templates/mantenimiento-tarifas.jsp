...
<head>
  ...
  <title>Mantenimiento tarifas</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Mantenimiento de tarifas</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                        <th><button type = "button" class="btn btn-primary btn-user btn-block" data-toggle="modal" data-target="#myModal">Nueva tarifa</button></th>
                        <th><a href="#" class="btn btn-primary btn-user btn-block">Editar tarifa</a></th>
                        
                        <th><a href="#" class="btn btn-primary btn-user btn-block">Eliminar tarifa</a></th>
                        </th>
                    </tr>
                    <tr>
                      <th>Nombre</th>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <section class="form-group">
                      <label for="nivelCurso">* Nombre</label>
