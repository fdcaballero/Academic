...
<head>
  ...
  <title>Mantenimiento asignaturas</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar --><ul  th:replace="layout/base::sidebar()" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar"></ul>
  <!-- End of Sidebar -->
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                        <th><button type = "button" class="btn btn-primary btn-user btn-block" data-toggle="modal" data-target="#myModal">Nueva asignatura</button></th>
                        <th><a href="#" class="btn btn-primary btn-user btn-block">Editar asignatura</a></th>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <section class="form-group">
                      ...
                      <select name="" id="cursoAsignatura" class="form-control">
